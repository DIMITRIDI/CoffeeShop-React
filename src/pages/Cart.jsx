         ...
         <div className="cart__container">
            ...
            <div className="cart__bottom">
               ...
               <div className="cart__bottom-buttons">
                  <a href="/" className="button button__param">
                     <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 13L1 6.93015L6.86175 1" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                     </svg>
                     <Link to="/">
                        <span>Come back</span>
                     </Link>
                  </a>
                  <button className="button button__param">
                     <span>Pay now</span>
                  </button>
               </div>
            </div>
